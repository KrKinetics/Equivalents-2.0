...
(function () {
    ...
    getPDFStylesCSS = function () {
        return krBasePdfStyles()
            // Containment: every PDF container must stay inside the A4 page width (FR + EN).
            + '.pdf-a4-page{width:794px;max-width:794px;overflow:hidden;box-sizing:border-box;}'
            + '.pdf-a4-page .pdf-page-body,.pdf-a4-page .info-grid,.pdf-a4-page .meals-grid,.pdf-a4-page .pdf-recon,.pdf-a4-page .pdf-macro-chart,.pdf-a4-page .pdf-coach-notes,.pdf-a4-page .pdf-brand-header,.pdf-a4-page .pdf-brand-rule,.pdf-a4-page .pdf-section{width:100%;max-width:100%;box-sizing:border-box;}'
            + '.pdf-a4-page .pdf-totals,.pdf-a4-page .pdf-footer{max-width:none;box-sizing:border-box;}'
            + '.pdf-a4-page .info-grid > *,.pdf-a4-page .meals-grid > *,.pdf-a4-page .meals-col,.pdf-a4-page .meal-box,.pdf-a4-page .pdf-macro-chart-row,.pdf-a4-page .pdf-pie-wrap,.pdf-a4-page .pdf-brand-copy{min-width:0;max-width:100%;}'
            + '.info-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:8px;margin-bottom:10px;}'
            + '.meals-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:8px;align-items:start;}'
            + '.info-table,.pdf-recon table,.macro-ratio-table{width:100%;max-width:100%;table-layout:fixed;border-collapse:collapse;}'
            + '.info-table td,.pdf-recon td,.meal-title,.meal-list li,.pdf-brand-title,.pdf-brand-subtitle,.pdf-totals,.pdf-footer,.pdf-recon-note,.pdf-coach-notes-body{overflow-wrap:anywhere;word-break:break-word;}'
            + '.pdf-recon{margin:8px 0 10px;border:1px solid #cbd5e1;border-radius:6px;overflow:hidden;min-width:0;}'
            + '.pdf-brand-header{height:auto;min-height:72px;background:linear-gradient(135deg,#071B41 0%,#0B285B 68%,#071B41 100%);display:flex;align-items:center;gap:10px;padding:10px 14px;color:#fff;border-radius:7px 7px 0 0;overflow:hidden;}'
            + '.pdf-brand-header-logo{flex:0 0 auto;flex-shrink:0;width:auto;max-width:190px;display:flex;align-items:center;}'
            + '.pdf-brand-header-logo img{width:auto;max-width:180px;height:auto;max-height:48px;object-fit:contain;display:block;flex-shrink:0;}'
            + '.pdf-brand-copy{flex:1 1 auto;min-width:0;text-align:right;padding-left:8px;}'
            + '.pdf-brand-title{font-size:15px;font-weight:800;letter-spacing:.3px;line-height:1.2;color:#fff;max-width:100%;}'
            + '.pdf-brand-subtitle{font-size:9px;color:#cbd8eb;margin-top:4px;letter-spacing:.2px;max-width:100%;}'
            + '.pdf-brand-day{font-size:10px;color:#fff;margin-top:4px;font-weight:700;}.pdf-brand-rule{height:4px;background:#ED1136;margin-bottom:12px;border-radius:0 0 3px 3px;}'
