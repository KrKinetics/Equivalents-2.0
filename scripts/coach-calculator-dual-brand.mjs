...
getPDFStylesCSS = function () {
    return professionalPdfStylesBase()
        // Seven-meal compaction: recover vertical space so all seven meals plus
        // the reconciliation table, macro chart and coach notes fit on one A4
        // page without shrinking the base font or forcing a page break.
        + '.pdf-page-body{padding-bottom:52px;}'
        + '.pdf-section{margin:0 0 5px;}'
        + '.info-grid{margin-bottom:7px;}'
        + '.info-table td,.pdf-recon td{padding:3px 8px;}'
        + '.meal-box{margin-bottom:4px;padding:4px 8px;}'
        + '.meal-list li{margin:0 0;}'
        + '.pdf-macro-chart{margin:5px 0 6px;padding:7px 10px;}'
        + '.pdf-coach-notes{margin:6px 0 6px;padding:7px 10px;}'
