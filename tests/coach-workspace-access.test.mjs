...
test('workspace open path encodes client id', () => {
...
test('same-org real client opens with matching brand stub', () => {
  const client = {
    id: 'aaaaaaaa-bbbb-4ccc-8ddd-eeeeeeeeeeee',
    full_name: 'Client KR',
    notes: 'dossier réel',
...
test('fictional clients are refused', () => {
  ...
  assert.throws(
    ...
    /client réel|dossier doit correspondre à un client réel/i,
  );
});
